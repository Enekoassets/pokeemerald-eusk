...
static const u8 sText_PkmnIsGlowing[] = _("{B_ATK_NAME_WITH_PREFIX} gistiratsu Abileziaago!");
static const u8 sText_PkmnFlewHigh[] = _("{B_ATK_NAME_WITH_PREFIX} oso gora\Gorputzada hegan!");
...
const u8 gText_Body[] = _("Gorputza");
...
static const u8 sText_RefJudgeBody[] = _("EPAILEA: 3. epai kategoria, Gorputza!\nBizitasun handieneko POKéMONA!\p");
