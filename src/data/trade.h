...
static const u8 sText_SpaceMove[] = _(" ERASOA"); // unused
static const u8 sText_NewLine[] = _("\n");
static const u8 sText_Slash[] = _("/");
static const u8 sText_Lv[] = _("Ml. ");
static const u8 sText_ThreeDashes[] = _("---");
static const u8 sText_FourQuestionMarks[] = _("????");
static const u8 sText_UnusedEmpty[] = _("");
static const u8 sText_IsThisTradeOkay[] = _("Ondo dago al trukea?");
static const u8 sText_Cancel[] = _("EZEZTATU");
static const u8 sText_ChooseAPkmn[] = _("Aukeratu POKéMON bat.");
static const u8 sText_Summary[] = _("LABURPENA");
static const u8 sText_Trade[] = _("TRUKATU");
static const u8 sText_CancelTrade[] = _("Trukea ezeztatu?");
static const u8 sJPText_PressBButtonToQuit[] = _("Bボタン　で　もどります");
static const u8 sText_Summary2[] = _("LABURPENA");
static const u8 sText_Trade2[] = _("TRUKATU");
static const u8 sText_CommunicationStandby[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Komunikazioa geldi…\nItxaron, mesedez.");
static const u8 sText_TheTradeHasBeenCanceled[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Trukea ezeztatu\negin da.");
static const u8 sText_OnlyPkmnForBattle[] = _("Hori borrokarako duzun\nPOKéMON bakarra da.");
static const u8 sText_WaitingForYourFriend[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Zure lagunak bukatzeko\nitxaroten…");
static const u8 sText_YourFriendWantsToTrade[] = _("Zure lagunak POKéMONAK\ntrukatu nahi ditu.");
